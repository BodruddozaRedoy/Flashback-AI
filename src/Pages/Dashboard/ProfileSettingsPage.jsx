...
const historyData = [
  { id: '2222JJJ2', coins: 1, date: '11\\12\\2222' },
];
    ...
    <div className="flex-1 bg-[#fdfcfb] py-12 px-6 flex flex-col items-center animate-in fade-in duration-500 overflow-y-auto">
      <div className="w-full max-w-xl">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-sm font-medium text-gray-500 italic">johndoe@gmail.com</p>
        </div>
        ...
        <div className="space-y-6 mb-10">
          ...
          {/* Referral URL */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-600 uppercase tracking-tight">Referral URL</label>
            <div className="relative">
              <input 
                readOnly
                value={referral}
          ...
          {/* Social Connections */}
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-600 uppercase tracking-tight">Connect with account</label>
            <div className="space-y-3">
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 leading-none mb-1">Google</p>
                    <p className="text-[11px] text-gray-400 font-medium">Not connected</p>
                  </div>
                </div>
                <button className="text-[11px] font-bold text-[#7c602e] hover:underline uppercase tracking-wider">Link</button>
              </div>
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-4 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-900 leading-none mb-1">Facebook</p>
                    <p className="text-[11px] text-gray-400 font-medium">Not connected</p>
                  </div>
                </div>
                <button className="text-[11px] font-bold text-[#7c602e] hover:underline uppercase tracking-wider">Link</button>
          ...
          <div className="space-y-2">
             <div className="flex items-center justify-between mb-1 px-1">
                <label className="text-xs font-bold text-gray-600 uppercase tracking-tight">Credit uses history</label>
                <button className="text-[11px] font-bold text-[#7c602e]/60 hover:text-[#7c602e]">View All</button>
             </div>
                ...
                <table className="w-full text-center text-[11px]">
                  <thead>
                    <tr className="bg-gray-50/50 text-gray-500 font-bold border-b border-gray-100">
                      <th className="py-4 font-bold uppercase tracking-wider">Moment ID</th>
                      <th className="py-4 font-bold uppercase tracking-wider">Coins Use</th>
                      <th className="py-4 font-bold uppercase tracking-wider">Date</th>
                    </tr>
                  </thead>
                  <tbody>
                    {historyData.map((row, idx) => (
                      <tr key={idx} className="text-gray-900 font-medium">
                        <td className="py-5 underline decoration-[#7c602e]/30 underline-offset-4 text-gray-400 cursor-pointer">{row.id}</td>
