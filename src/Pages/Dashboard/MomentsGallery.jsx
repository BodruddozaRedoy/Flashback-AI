    ...
    return (
      <div className="flex-1 bg-[#fdfcfb] p-8 md:p-12 overflow-y-auto animate-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center">
          ...
          {/* Final Submit Button */}
          <button className="w-full bg-[#7c602e] hover:bg-[#634d25] text-white py-4.5 rounded-2xl font-bold text-sm shadow-xl shadow-[#7c602e]/30 transition-all active:scale-[0.98] flex items-center justify-center gap-2 py-4">
            Create your moment
          </button>
        </div>
      </div>
